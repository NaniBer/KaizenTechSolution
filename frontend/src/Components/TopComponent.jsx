  ...
  const handleFABToggle = () => {
    ...
    return(
            ...
            <div className=" text-white lg:text-lg text-sm flex ">
                <p className="mr-8 cursor-pointer hover:underline hover:underline-offset-4 hover:decoration-red hidden md:block"><a href="/#home">Home</a></p>
                <p className="mr-8 cursor-pointer hover:underline hover:underline-offset-4 hover:decoration-red hidden md:block"><a href="/#about">About</a></p>
                <p className="mr-8 cursor-pointer hover:underline hover:underline-offset-4 hover:decoration-red hidden md:block"><a href="/portfolio">Portfolio</a></p>
                <p className="mr-8 cursor-pointer hover:underline hover:underline-offset-4 hover:decoration-red hidden md:block"><a href="#contact">Contact</a></p>
            </div>
