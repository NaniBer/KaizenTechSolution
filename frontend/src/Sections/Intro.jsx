...
const Intro=()=>{
    ...
    return(
        ...
        <div className="flex flex-col justify-center items-center lg:mb-0 mb-36" id="home">
            <img src={require("../Assets/klogo5.png")} className="md:h-56 h-24" alt=""/>
            <p className="lg:w-3/4 mt-10 leading-tight tracking-widest lg:text-lg lg:font-semibold text-center text-base lg:m-0 m-5 ">Welcome to Kaizen Digital Solutions.
